...
consumer = KafkaConsumer("gsr", bootstrap_servers=['kafka:9092'], value_deserializer=lambda m: json.loads(m.decode('utf-8')), api_version=(0,10))
...
class Logger:
    ...
    def init_new_logger(self, guid):
        ...
        self.logdict[guid] = (datafile, csv.DictWriter(datafile, fieldnames=["Timestamp", "PacketNr", "GSR"]))
